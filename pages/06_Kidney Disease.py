...
pot = st.number_input("What is your potassium level?", value=4, step=0.1)
hemo = st.number_input("What is your hemoglobin level?", value=10, step=0.1)
...
rc = st.number_input("What is your red blood cell count?", value=4, step=0.1)
